...
wget https://github.com/QEF/q-e/archive/refs/tags/qe-7.3.tar.gz            # qe version 7.3 (2023) from repository, as tar.gz file
tar -xvzf qe-7.3.tar.gz
cd q-e-qe-7.3

# downloading thermo_pw tar file into QE directory
wget http://people.sissa.it/%7Edalcorso/thermo_pw/thermo_pw.2.0.0.tar.gz
